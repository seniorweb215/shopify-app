...
<div id="kt_header_mobile" class="kt-header-mobile  kt-header-mobile--fixed ">
    <div class="kt-header-mobile__logo">
        <a href="{{ route('dashboard') }}">
            <img alt="Logo" src="{{ asset('media/logo-main.svg') }}" />
        </a>
    </div>
            ...
            <div class="kt-aside-menu-wrapper kt-grid__item kt-grid__item--fluid" id="kt_aside_menu_wrapper">
                <div id="kt_aside_menu" class="kt-aside-menu " data-ktmenu-vertical="1" data-ktmenu-scroll="1" data-ktmenu-dropdown-timeout="500">
                    <ul class="kt-menu__nav ">
                        @if (Auth::user()->type == 1)
                            <li class="kt-menu__item <?php echo $link == 'supplier/dashboard' ? 'kt-menu__item--active': ''; ?>" aria-haspopup="true">
                                <a href="/supplier/dashboard" class="kt-menu__link ">
                            ...
                            <li class="kt-menu__item <?php echo $link == 'supplier/product' ? 'kt-menu__item--active': ''; ?>" aria-haspopup="true" data-ktmenu-submenu-toggle="hover">
                                <a href="/supplier/product" class="kt-menu__link kt-menu__toggle">
                                    <span class="kt-menu__link-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                <rect x="0" y="0" width="24" height="24" />
                            ...
                            <li class="kt-menu__item" aria-haspopup="true" data-ktmenu-submenu-toggle="hover">
                                <a href="{{ route('logout') }}" class="kt-menu__link kt-menu__toggle" onclick="event.preventDefault(); document.getElementById('nav_logout_form').submit();">
                                    <span class="kt-menu__link-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                ...
                                <form id="nav_logout_form" method="POST" action="{{ route('logout') }}" style="display: none">
                                    @csrf
                                </form>
                            </li>
                        @else
                            <li class="kt-menu__item <?php echo $link == 'retailer/dashboard' ? 'kt-menu__item--active': ''; ?>" aria-haspopup="true">
                                <a href="/retailer/dashboard" class="kt-menu__link ">
                                    <span class="kt-menu__link-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                <polygon points="0 0 24 0 24 24 0 24" />
                            ...
                            <li class="kt-menu__item <?php echo $link == 'retailer/approved_product' ? 'kt-menu__item--active': ''; ?>" aria-haspopup="true" data-ktmenu-submenu-toggle="hover">
                                <a href="/retailer/approved_product" class="kt-menu__link kt-menu__toggle">
                                    ...
                                    <span class="kt-menu__link-text">Approved Product</span>
                                </a>
                            </li>
                            <li class="kt-menu__item <?php echo $link == 'retailer/profile' ? 'kt-menu__item--active': ''; ?>" aria-haspopup="true" data-ktmenu-submenu-toggle="hover">
                                <a href="{{ route('r_profile') }}" class="kt-menu__link kt-menu__toggle">
                                    <span class="kt-menu__link-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                <polygon points="0 0 24 0 24 24 0 24"></polygon>
